...
f= open('./cora-origin/cora.cites', 'r')
...
f_e= open('./cora-processed/cora.edgelist', 'w')          
...
f= open('./cora-origin/cora.content', 'r')
...
f_l= open('./cora-processed/cora.labels', 'w')
  
f_vec= open('./cora-processed//cora.vectors', 'w') 
